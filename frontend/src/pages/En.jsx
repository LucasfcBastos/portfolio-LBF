  ...
  return (
    <div>
      ...
      <div id="intro">
        ...
        <div className="introContent">
          ...
          <div className="textIntro">
            ...
            <div className="button-container">
              <a href="/LucasBastosFranco_CVen.pdf" download>
        ...
        <CampDados dados={[
          { tipo: "CERTIFICATES", quantidade: 35 },
          { tipo: "SOFT SKILLS", quantidade: 9 },
          { tipo: "EXPERIENCE", quantidade: 0 },
        ]} />
      ...
      <div id="sobre" className="topicos">
        <h1>ABOUT ME</h1>
        <p>Early-career software engineer passionate about technology and innovation. Experience in academic projects working as Product Owner, Product Designer, Frontend, Backend, and Quality Assurance. Seeking opportunities to gain practical experience and grow with the company.</p>
      </div>
      ...
      <div id="projetos" className="topicos">
        <h1>PROJECTS</h1>
        <p style={{ marginBlockStart: '1em', marginBlockEnd: '1em' }}>Academic Projects:</p>
        <CampStartup startup={[
          { nome: 'BYTE DONTO', descricao: 'Facilitates communication between clinics and patients, reducing absences and improving treatment follow-up.', img: BD, tools: ['Notion', 'Figma', 'React', 'NodeJS', 'Python', 'IA'], helf: 'INSTAGRAM', instagram: 'https://www.instagram.com/bytedonto' },
          { nome: 'ROTA VERDE', descricao: 'Optimizes selective collection routes to reduce costs and increase the operational efficiency of cooperatives.', img: RV, tools: ['Word', 'Figma', 'React Native', 'Python'], helf: 'INSTAGRAM', instagram: 'https://www.instagram.com/rota_verde_' },
          { nome: 'R.A.S', descricao: 'It allows you to track the life cycle of livestock and manage health documentation in a reliable and automated manner.', img: RAS, tools: ['Figma', 'React', 'Java', 'Spring Boot', 'IoT'], helf: 'INSTAGRAM', instagram: 'https://www.instagram.com/squad_r.a.s' },
        ]} />
        <p style={{ marginBlockStart: '1em', marginBlockEnd: '1em' }}>Personal Projects:</p>
      ...
      <div id="educacao" className="topicos">
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <p>Currently, I am pursuing a degree in Software Engineering at the Evangelical University of Goiás (UniEVANGÉLICA), in Anápolis-GO. I started my undergraduate studies in February 2023, and the expected completion date is December 2026. I am currently in the 6th semester, with approximately one year remaining to complete the course.</p>
          <img style={{ width: '20em', height: 'auto', marginRight: '3em' }} src={UniEvangelica} />
        </div>
        <p style={{ marginBlockStart: '1em', marginBlockEnd: '1em' }}>CERTIFICATION:</p>
        <CampCertificados certificados={[
          { img: LogoUni, nome: 'Basic Course in Interface Design with Figma', origem: 'eventoscae.aee.edu.br' },
          { img: LogoUni, nome: 'Mastering Chat GPT', origem: 'eventoscae.aee.edu.br' },
          { img: LogoMicro, nome: 'Introduction to Web Development using Visual Studio Code', origem: 'learn.microsoft.com' },
          { img: LogoScrum, nome: 'Scrum Fundamentals Certified', origem: 'scrumstudy.com' },
          { img: LogoDio, nome: 'Versioning Code with Git and GitHub', origem: 'dio.me' },
          { img: LogoCampos, nome: 'Marathon of the Agrostartup Challenge 2025', origem: 'eventos.sistemafaeg.org.br' },
          { img: LogoSenar, nome: 'Intermediate Excel', origem: 'ead.senargo.org.br' },
          { img: LogoSenar, nome: 'Intermediate Word', origem: 'ead.senargo.org.br' },
          { img: LogoCampos, nome: 'Entrepreneurial Training - Agrostartup Challenge 2025', origem: 'eventos.sistemafaeg.org.br' },
          { img: LogoDio, nome: 'Modularization of Node.js Projects with CommonJS', origem: 'dio.me' },
          { img: LogoDio, nome: 'Modularization with EcmaScript Modules', origem: 'dio.me' },
        ]} />
      </div>

      <div id="contatos" className="topicos">
        <h1>CONTACT</h1>
        <CampForm inpN='Name' inpNH='Enter your name' inpE='Email' inpEH='Enter your email' inpD='Message' inpDH='Enter your message' sub='Send' />
      </div>
      ...
      <div className="box text">
        <p>@lucasfcbastos - All rights reserved</p>
      </div>
